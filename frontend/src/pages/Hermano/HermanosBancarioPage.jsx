...
export function HermanosBancarioPage() {
    ...
    const columns = useMemo(() => [
        ...
        },
        {
            ...
            accessor: 'titular_cuenta_bancaria'
        },
        {
            Header: 'DNI',
            accessor: 'dni'
    ...
    return (
        <div className='max-w-4xl mx-auto my-5'>
                <h1 className="text-2xl font-bold mb-5">Listado de información bancaria de Hermanos</h1>
