...
import { faList, faEnvelope, faMoneyBill, faUserPlus, faUserMinus, faTicketAlt } from '@fortawesome/free-solid-svg-icons';
...
export function MenuHermanoPage() {
        ...
        <>
            ...
            <div className="mx-auto p-1 my-1 xl:max-w-6xl l:max-w-xl xl:grid grid-cols-12">
                <div className='col-start-1 col-span-4'>
                    <div className="grid grid-cols-1 gap-10 mb-5">
                        <MenuButton icon={faList} text="LISTADO DE HERMANOS" link="/hermanos" />
                        {/* <MenuButton icon={faMoneyBill} text="SACAR CUOTAS" link="/pagos"/> */}
                ...
                <div className='col-start-9 col-span-4'>
                    <div className="grid grid-cols-1 gap-10 mb-5">
                        ...
                        <MenuButton icon={faList} text="LISTADO DE CARTAS" link="/cartas" />
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)}>
                <div>
                    ...
                    <p> Aquí se muestran las acciones que se pueden llevar a cabo relacionado con los hermanos. <br />
