...
export function MenuInventarioPage() {
            ...
            <div className="mx-auto p-1 my-1 xl:max-w-6xl l:max-w-xl xl:grid grid-cols-12">
                <div className='col-start-1 col-span-4'>
                    <div className="grid grid-cols-1 gap-10 mb-5">
                            <MenuButton  icon={faPlus} text="AÑADIR INVENTARIO" link="/inventario" />
                            <MenuButton icon={faList} text="LISTADO DE INVENTARIO" link="/inventarios"/>
                ...
                <div className='col-start-9 col-span-4'>
                    <div className="grid grid-cols-1 gap-10 mb-5">
                        ...
                        <MenuButton icon={faList} text="LISTADO PATRIMONIO" link="/patrimonios"/>
